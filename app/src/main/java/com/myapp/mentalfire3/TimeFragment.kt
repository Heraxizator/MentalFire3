...
import com.myapp.mentalfire3.databinding.FragmentTimeBinding


class TimeFragment : Fragment(), View.OnClickListener, View.OnKeyListener {
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            R.id.btnend -> {
                findNavController().navigate(R.id.action_timeFragment_to_SecondFragment)
            }
    ...
    override fun onKey(p0: View?, p1: Int, p2: KeyEvent?): Boolean {
        if ((p1 == KeyEvent.KEYCODE_ENTER) && (p0?.id == R.id.question6)) {
    ...
    override fun onDestroy() {
        ...
        ad.loadFullScreenAd("R-M-1708838-17")
