...
import com.myapp.mentalfire3.databinding.FragmentFiveBinding


class FiveFragment : Fragment(), View.OnClickListener, View.OnKeyListener {
    ...
    override fun onKey(p0: View?, p1: Int, p2: KeyEvent?): Boolean {
        if ((p1 == KeyEvent.KEYCODE_ENTER) && (p0?.id == R.id.question5)) {
    ...
    override fun onDestroy() {
        ...
        ad.loadFullScreenAd("R-M-1708838-9")
